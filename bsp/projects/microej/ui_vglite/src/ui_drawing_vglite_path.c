 ...
 * @return: -1 if there is not enough memory in the buffer, otherwise the new path_offset
 */
static int __cubic_to(int16_t cx1,
                      int16_t cy1,
                      int16_t cx2,
                      int16_t cy2,
                      int16_t x,
 ...
 * - otherwise: the updated path offset
 */
static int __approximate_ellipse_arc_to(int radius_w,
                                        int radius_h,
 ...
 * - otherwise: the updated path offset
 */
static int __approximate_ellipse_arc_fragment_to(int radius_w,
                                                 int radius_h,
                                                 float32_t start_angle,
                                                 float32_t end_angle);
 ...
 * - otherwise: the updated path offset
 */
static int __approximate_ellipse_arc_fragment(uint16_t center_x,
                                              uint16_t center_y,
                                              int radius_w,
                                              int radius_h,
 ...
 * - otherwise: the updated path offset
 */
static int __multiple_quarter_curve_to(int radius_w,
                                       int radius_h,
                                       int start,
                                       int number);
 ...
 * @return: -1 if there is not enough memory in the buffer, otherwise the new path_offset
 */
static int __approximate_ellipse_arc(int radius_out_w,
                                     int radius_out_h,
                                     int radius_in_w,
                                     int radius_in_h,
                                     float32_t start_angle_rad,
