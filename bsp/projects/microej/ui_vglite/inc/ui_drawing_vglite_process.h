 ...
 * @see vg_lite_draw()
 */
typedef DRAWING_Status (* UI_DRAWING_VGLITE_PROCESS_draw_path_t) (MICROUI_GraphicsContext *gc,
                                                                  vg_lite_path_t *path,
 ...
 */
typedef DRAWING_Status (* UI_DRAWING_VGLITE_PROCESS_blit_rect_t)(MICROUI_GraphicsContext *gc,
 ...
 * @see vg_lite_clear()
 */
typedef DRAWING_Status (* UI_DRAWING_VGLITE_PROCESS_clear_t)(MICROUI_GraphicsContext *gc,
