 ...
 */
int UI_DRAWING_VGLITE_PATH_compute_ellipse_arc(vg_lite_path_t *thick_ellipse_arc_shape,
                                               int radius_out_w,
                                               int radius_out_h,
                                               int radius_in_w,
                                               int radius_in_h,
 ...
 * 	otherwise: number of bytes written in the path
 */
int UI_DRAWING_VGLITE_PATH_compute_thick_shape_ellipse_arc(vg_lite_path_t *thick_ellipse_arc_shape,
                                                           int diameter_w,
                                                           int diameter_h,
                                                           int thickness,
                                                           float32_t start_angle_degree,
 ...
 * 	otherwise: number of bytes written in the path
 */
int UI_DRAWING_VGLITE_PATH_compute_ellipse(vg_lite_path_t *point_shape,
                                           int path_offset,
                                           int radius_w,
                                           int radius_h,
                                           bool end_path);
 ...
 * 	otherwise: number of bytes written in the path
 */
int UI_DRAWING_VGLITE_PATH_compute_filled_ellipse(vg_lite_path_t *point_shape,
                                                  int radius_w,
                                                  int radius_h,
 ...
 *     otherwise: number of bytes written in the path
 */
int UI_DRAWING_VGLITE_PATH_compute_rectangle(vg_lite_path_t *rounded_rectangle_shape,
                                             int path_offset,
                                             int x,
                                             int y,
                                             int width,
 ...
 * 	otherwise: number of bytes written in the path
 */
int UI_DRAWING_VGLITE_PATH_compute_rounded_rectangle(vg_lite_path_t *rounded_rectangle_shape,
                                                     int path_offset,
                                                     int x,
                                                     int y,
                                                     int width,
 ...
 * 	otherwise: number of bytes written in the path
 */
int UI_DRAWING_VGLITE_PATH_compute_thick_shape_line(vg_lite_path_t *thick_line_shape,
                                                    int x,
                                                    int y,
                                                    int thickness,
                                                    int caps,
