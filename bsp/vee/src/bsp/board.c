 ...
 ******************************************************************************/
#if defined(SDK_I2C_BASED_COMPONENT_USED) && SDK_I2C_BASED_COMPONENT_USED
static lpi2c_rtos_handle_t g_lpi2c5_freertos_handle = {.base = NULL};
#endif /* SDK_I2C_BASED_COMPONENT_USED */
/*******************************************************************************
 * Code
 ******************************************************************************/
...
{
    if (g_lpi2c5_freertos_handle.base == NULL) {
        NVIC_SetPriority(LPI2C5_IRQn, 2);
        lpi2c_master_config_t lpi2cConfig = {0};
        LPI2C_MasterGetDefaultConfig(&lpi2cConfig);
        LPI2C_RTOS_Init(&g_lpi2c5_freertos_handle, BOARD_ACCEL_I2C_BASEADDR, &lpi2cConfig, BOARD_ACCEL_I2C_CLOCK_FREQ);
    }
}
...
status_t BOARD_Accel_I2C_Send(uint8_t deviceAddress, uint32_t subAddress, uint8_t subAddressSize, uint32_t txBuff)
{
    ...
    xfer.dataSize       = 1;
    return LPI2C_RTOS_Transfer(&g_lpi2c5_freertos_handle, &xfer);
}
