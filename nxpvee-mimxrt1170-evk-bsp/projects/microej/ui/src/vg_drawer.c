...
BSP_DECLARE_WEAK_FCNT VG_DRAWER_drawer_t* VG_DRAWER_get_drawer(MICROUI_GraphicsContext* gc){
...
// See the header file for the function documentation
inline void VG_DRAWER_update_color(void* target, vg_lite_color_t* color) {
	(void)target;
	VGLITE_PATH_update_color(color);
}

// See the header file for the function documentation
inline void VG_DRAWER_update_gradient(void* target, vg_lite_linear_gradient_t* gradient) {
	(void)target;
	VGLITE_PATH_update_gradient(gradient);
}
...
inline void VG_DRAWER_update_gradient(void* target, vg_lite_linear_gradient_t* gradient) {
	// cppcheck-suppress [misra-c2012-11.5] cast to (VG_DRAWER_drawer_t *) is valid
	VG_DRAWER_drawer_t* drawer = (VG_DRAWER_drawer_t*)target;
	drawer->update_gradient(gradient);
}
