 ...
 * @return: nothing
 */
typedef void (* VG_DRAWER_update_color_t) (vg_lite_color_t* color);
 ...
 * @return: nothing
 */
typedef void (* VG_DRAWER_update_gradient_t) (vg_lite_linear_gradient_t* gradient);
 ...
 * @return: nothing
 */
void VG_DRAWER_update_color(void* target, vg_lite_color_t* color) ;
 ...
 * @return: nothing
 */
void VG_DRAWER_update_gradient(void* target, vg_lite_linear_gradient_t* gradient) ;
