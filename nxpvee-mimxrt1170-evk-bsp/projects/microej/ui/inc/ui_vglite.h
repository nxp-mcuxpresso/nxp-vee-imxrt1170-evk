 ...
 * a set of helper functions to target the VG-Lite library.
...
/*
 * @brief Operation to perform after a VG-Lite drawing operation.
...
/*
 * @brief Get color to give to VG-Lite library according to destination's foreground
 ...
 *
 * Otherwise the VG-Lite scissor is configured to match the intersection of the
